module.exports = function init(site) {
  ...
  site.post("/api/employee_offer/add", (req, res) => {
    ...
    $employee_offer.add(employee_offer_doc, (err, doc) => {
      if (!err) {
        site.call('[employee offer] please add money to safe' , doc)
        site.call('[employee offer] please add money to safe payments' , doc)
        response.done = true
      } else {
  ...
  site.post("/api/employee_offer/delete", (req, res) => {
    ...
    if (_id) {
      $employee_offer.delete({
        ...
        if (!err) {
          site.call('[employee offer] please discount money from safe' , result.doc)
          site.call('[employee offer] please delete row from safe payments' , result.doc)
